...
public interface DocumentService {
    DocumentResponse uploadForPreRegistration(Long preRegistrationId, MultipartFile file, DocumentType documentType, DocumentSide side, String label, String documentNumber);
